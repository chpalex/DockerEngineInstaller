...
- asks if the user want to use SSL
- check if any jks are available and offers the user to use those
- prompt user if they want to use SSL or not
...
- create duckdns.ini with the tokento use with SWAG
...
- retrieve a user, password and key for WSE as well as email address for SSL configuration
- run a docker compose command to sping up the custom Engine image, SWAG and Portainer
